<%@page import="com.kh.jsp.board.model.dto.Attachment"%>
	...
	<div class="outer">
		<table class="detail" align="center">
			...
			<tr>
				<td>대표사진</td>
				<td colspan="4">
					<img id="titleImg" alt="" src="<%=request.getContextPath()%>/thumbnail_uploadFiles/<%=titleImg.getChangeName()%>">
				</td>
				<td>
			...
			<tr>
				<td>
					<div class="detailImgArea">
						<img id="detailImg1" class="detailImg" src="<%=request.getContextPath()%>/thumbnail_uploadFiles/<%=detailImg1.getChangeName() %>">
						<button onclick="location.href='<%=request.getContextPath()%>/Download.tn?num=<%=detailImg1.getFid() %>'">다운로드</button>
					</div>
				</td>
				<td>
					<div class="detailImgArea">
						<img id="detailImg2" class="detailImg" src="<%=request.getContextPath()%>/thumbnail_uploadFiles/<%=detailImg2.getChangeName() %>">
						<button onclick="location.href='<%=request.getContextPath()%>/Download.tn?num=<%=detailImg2.getFid() %>'">다운로드</button>
					</div>
				</td>
				<td>
					<div class="detailImgArea">
						<img id="detailImg3" class="detailImg" src="<%=request.getContextPath()%>/thumbnail_uploadFiles/<%=detailImg3.getChangeName() %>">
