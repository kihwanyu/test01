...
import com.kh.jsp.board.model.dto.PageInfo;
...
public class SelectBoardList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Board> list = new BoardService().selectBoardList(currentPage, limit);
		String page = "";
		...
		if(list != null){
			...
			request.setAttribute("msg", "게시판 리스트 조회 에러~!");
